/**
 * HighlightScanner — Calls PhoenixUiApiService.scanImplicitAsync() and returns raw spans.
...
export class HighlightScanner {
    ...
    /**
     * Scan text for implicit entity matches using the Phoenix literal dictionary.
