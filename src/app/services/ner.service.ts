...
class FstEntitySuggestionProvider implements EntitySuggestionProviderApi {
...
export class NerService {
    ...
    constructor() {
        this.fstProvider = new FstEntitySuggestionProvider(this.phoenixUiApi);
    ...
    private mapProviderSuggestions(
        ...
        return providerSuggestions
            ...
            .map((suggestion) => ({
                ...
                llmEnhanced: providerId === 'lfm_local_experiment',
